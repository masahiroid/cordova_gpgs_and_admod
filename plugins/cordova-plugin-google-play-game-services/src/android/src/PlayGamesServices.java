...
public class PlayGamesServices extends CordovaPlugin {
    ...
    private void sendUnauthorized(String message) {
        try {
            ...
            if (message == null) {
                result.put("message", "User is not logged in");
            } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                LOG.d(LOG_TAG, "signin FAILED" + message);
                ...
                onDisconnected("signin failed" + message);
            } catch (JSONException ignored) {
                LOG.d(LOG_TAG, "signin FAILED JSON parsing err");
            }
        }
    }
