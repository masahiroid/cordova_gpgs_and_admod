...
function __sprite_32() { 
__sprite_init__(this, sprite_32, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/sprite_32_0.png']);
}; var sprite_32 = new __sprite_32();

function __sprite_33() { 
__sprite_init__(this, sprite_33, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/sprite_33_0.png']);
}; var sprite_33 = new __sprite_33();
...
__instance_init__(this, obj_btn_load, null, 1, 0, btn_002, 1, 1);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
__instance_init__(this, object_25, null, 1, 0, sprite_23, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
__instance_init__(this, object_26, null, 1, 0, sprite_24, 1, 3);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
function __object_34() {
__instance_init__(this, object_34, null, 1, 0, sprite_32, 1, 4);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, object_34)) {
	sound_play(snd_button);
	show_Achievements();
	};
}
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_34 = new __object_34();

function __object_35() {
__instance_init__(this, object_35, null, 1, 0, sprite_33, 1, 5);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, object_35)) {
	sound_play(snd_button);
	show_leaderboards();
	};
}
...
function __object_43() {
__instance_init__(this, object_43, null, 1, 0, null, 1, 6);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
...
__handle_sprite__(this);
with(this) {
draw_text(30, 100, "リーダボード");
draw_text(30, 200, "アチーブメント");
draw_text(210, 100, "show_leaderboards");
draw_text(210, 200, "show_Achievements");
}
}
};
}; var object_43 = new __object_43();
...
this.objects = [
[{o:object_35, x:100, y:240}],
[{o:object_34, x:220, y:80}],
[{o:object_26, x:220, y:160}],
[{o:object_25, x:100, y:160}],
[{o:obj_btn_load, x:100, y:80}],
[{o:obj_btn_start, x:220, y:240}]];
this.start = function() {
...
cordova.plugins.playGamesServices.initializer();
//ondeviceready();
}
function sign_in() { 
cordova.plugins.playGamesServices.signin();
}
function show_leaderboards() { 
...
function show_stitial_show() { 
	admob.interstitial.show();

}
function show_prepare_show() { 
	admob.interstitial.prepare();
}
